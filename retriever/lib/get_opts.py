...
commit_parser.add_argument('-p', '--path', help='path to store committed file', default='.', nargs=1)
commit_parser.add_argument('-m', '--message', help='commit message', default='', nargs=1)
